...
from application import topic_interface, post_interface, user_interface, Group_interface, VotesInterface, subscriptionInterface, notificationInterface
...
application.config.update(dict(
    DATABASE=os.path.join(application.root_path, database.project_database)
))
application.config.from_envvar('PROJECT_SETTINGS', silent=True)
@application.route('/')
def index():
    topics = topic_interface.getTopics()
    return render_template('home.html', topics = topics)
    
@application.route('/topic/<int:topic_id>/posts')
...
@application.route('/topic/<int:topic_id>/post/<int:post_id>/')
...
@application.route('/createtopic/', methods=['GET', 'POST'])
def createtopic():
...
@application.route('/topic/<int:topic_id>/edittopic', methods=['GET', 'POST'])
...
@application.route('/topic/<int:topic_id>/createpost', methods=['GET', 'POST'])
...
@application.route('/topic/<int:topic_id>/post/<int:post_id>/editpost', methods=['GET', 'POST'])
...
@application.route('/Addmember/<int:group_id>',methods=['GET','POST'])
...
@application.route('/showgroup/<int:group_id>',methods=['GET', 'POST'])
...
@application.route('/startgroup', methods=['GET', 'POST'])
def creategroup():
    if request.method == 'POST':
...
#Voting
@application.route('/topic/<int:topic_id>/post/<int:post_id>/upvote/user/<string:username>')
...
@application.route('/topic/<int:topic_id>/post/<int:post_id>/downvote/user/<string:username>')
...
@application.route('/topic/<int:topic_id>/subscribe')
